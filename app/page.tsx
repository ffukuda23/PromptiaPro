    ...
    <main className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      */}
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        ...
        <h2 className="font-display text-4xl font-black tracking-tight mb-10">Prompts que entregam resultados reais</h2>
      ...
      */}
      <section id="como-funciona" className="max-w-5xl mx-auto px-6 py-14">
        ...
        <h2 className="font-display text-4xl font-black tracking-tight mb-10">Do acesso ao resultado em 3 passos</h2>
