    ...
    <main className="min-h-screen" style={{ background: 'var(--bg)' }}>
      ...
      */}
      <section id="categorias" className="max-w-5xl mx-auto px-6 pt-4 pb-14">
        ...
        <h2 className="font-display text-4xl font-black tracking-tight mb-3 uppercase">22 áreas do conhecimento</h2>
      ...
      <section className="max-w-5xl mx-auto px-6 py-8">
        ...
        <h2 className="font-display text-4xl font-black tracking-tight mb-10 uppercase">Prompts que entregam resultados reais</h2>
      ...
      */}
      <section id="como-funciona" className="max-w-5xl mx-auto px-6 py-14">
        ...
        <h2 className="font-display text-4xl font-black tracking-tight mb-10 uppercase">Do acesso ao resultado em 3 passos</h2>
      ...
      <section id="planos" className="max-w-5xl mx-auto px-6 py-14">
        ...
        <h2 className="font-display text-4xl font-black tracking-tight mb-3 uppercase">Simples assim — Free ou Pro</h2>
