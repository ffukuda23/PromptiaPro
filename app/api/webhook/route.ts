        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#1a1a1a;border-radius:16px;overflow:hidden;border:1px solid #2a2a2a;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#f59e0b,#d97706);padding:40px;text-align:center;">
              ...
              <h1 style="margin:0;color:#0f0f0f;font-size:28px;font-weight:800;letter-spacing:-0.5px;">
                PromptIA Pro
              </h1>
              <p style="margin:8px 0 0;color:#0f0f0f;opacity:0.7;font-size:14px;">
                Plataforma de Prompts Profissionais
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:48px 40px;">
              <h2 style="margin:0 0 16px;color:#f59e0b;font-size:22px;font-weight:700;">
                🎉 Seu Plano Pro está ativo!
              </h2>
              <p style="margin:0 0 24px;color:#d1d5db;font-size:16px;line-height:1.6;">
                Parabéns! Seu acesso ao <strong style="color:#fff;">Plano Pro</strong> foi ativado com sucesso. 
                Agora você tem acesso completo a todos os prompts profissionais da plataforma.
              </p>

              <!-- Benefícios -->
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#252525;border-radius:12px;padding:24px;margin-bottom:32px;">
                <tr><td>
                  <p style="margin:0 0 16px;color:#9ca3af;font-size:13px;text-transform:uppercase;letter-spacing:1px;font-weight:600;">
                    O que você desbloqueou
                  </p>
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="padding:8px 0;color:#d1d5db;font-size:15px;">
                        ⭐ Todos os prompts exclusivos Pro
                      </td>
                    </tr>
                    <tr>
                      <td style="padding:8px 0;color:#d1d5db;font-size:15px;">
                    ...
                    <tr>
                      <td style="padding:8px 0;color:#d1d5db;font-size:15px;">
                        🔄 Novos prompts adicionados mensalmente
                      </td>
                    </tr>
                    <tr>
                      <td style="padding:8px 0;color:#d1d5db;font-size:15px;">
                        💼 Prompts para negócios, jurídico, finanças e mais
                      </td>
                    </tr>
                  </table>
                </td></tr>
          ...
          <tr>
            <td style="background:#111;padding:24px 40px;border-top:1px solid #2a2a2a;">
              <p style="margin:0;color:#6b7280;font-size:13px;text-align:center;line-height:1.6;">
                ...
                <a href="mailto:suporte@promptiapro.com.br" style="color:#f59e0b;text-decoration:none;">
                  suporte@promptiapro.com.br
                </a>
                <br/>
                © 2026 PromptIA Pro — Todos os direitos reservados
              </p>
            </td>
          </tr>
  ...
  try {
    switch (event.type) {
      ...
      case 'invoice.payment_succeeded': {
        ...
        // Verificar se já existe assinatura (corrigido: sem .single())
        ...
        console.log(`✅ Plano Pro ativado e e-mail enviado para: ${email}`)
        break
      }
